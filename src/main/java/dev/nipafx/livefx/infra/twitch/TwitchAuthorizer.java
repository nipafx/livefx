...
import dev.nipafx.livefx.infra.twitch.store.AppCredentials;
import dev.nipafx.livefx.infra.twitch.store.Credentials;
import dev.nipafx.livefx.infra.twitch.store.UserCredentials;
import dev.nipafx.livefx.infra.twitch.store.UserToken;
...
public class TwitchAuthorizer {
	...
	private static final String USER_TOKEN_SCOPE = "channel:read:redemptions channel:manage:redemptions channel:manage:broadcast";
